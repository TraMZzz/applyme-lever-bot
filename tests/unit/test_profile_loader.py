...
def test_load_profile_maps_json(tmp_path):
    ...
    p.write_text(json.dumps({
        "full_name": "Ethan Calder", "email": "ethan@applyme.site", "phone": "9175552244",
        "location": "New York, NY, United States", "city": "New York", "state": "NY",
        "country": "United States", "work_authorized": True, "requires_sponsorship": False,
        "willing_to_relocate": False, "expected_salary": 140000,
    }))
